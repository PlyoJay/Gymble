...
namespace Gymble.Repositories
{
    public class MembershipRepository
    {
        ...
        public void InsertMembership(MemberMembership membership)
        {
        ...
        public List<MemberMembership> GetAllMembership()
        {
            var sql = "SELECT * FROM tb_membership";
            return _connection.Query<MemberMembership>(sql).ToList();
        }
    }
}
